...
module Accesos
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['ACCESOS_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Accesos::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Accesos::Action is included
      ...
      # Configure the code that will yield each time Accesos::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Accesos::Assets::Helpers
      end
    end
